...
import "./App.css"; 
import Toast from "../components/Toast.jsx"; // Adjust the path as necessary
...
const App = () => {
  ...
  return (
   <div className="bg-gray-950 flex items-center justify-center flex-col gap-8 text-white min-h-screen px-4">
  {/* Header */}
  ...
  {shortUrl && (
    <div className="w-full max-w-md mt-6">
      <div className="bg-gray-800 border border-gray-700 rounded-xl px-4 py-2 flex flex-row sm:flex-row items-center justify-between gap-3 hover:shadow-md transition">
        <p className="text-indigo-300 break-words">{shortUrl}</p>
        <button
          onClick={handleCopy}
